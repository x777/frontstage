...
test("every declared IconName renders a non-empty path set", () => {
  const names = ["folder","captions","plus","sparkles","search","ellipsis","grid","list","x","chevron-right","chevron-down","play","pause","step-back","step-forward","skip-to-start","skip-to-end","eye","eye-off","lock","lock-open","volume","volume-off","grip","diamond","diamond-filled","viewfinder"] as const;
