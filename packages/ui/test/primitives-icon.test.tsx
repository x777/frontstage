...
test("every declared IconName renders a non-empty path set", () => {
  const names = ["folder","captions","plus","sparkles","search","ellipsis","grid","list","x","chevron-right","chevron-down","play","pause","eye","eye-off","lock","lock-open","volume","volume-off","grip"] as const;
