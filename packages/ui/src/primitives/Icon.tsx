...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  // "arrow.uturn.backward" — ToolbarView.swift undo button. A hook sweeping up then left,
  ...
  // "arrow.uturn.forward" — mirror of undo.
  redo: (
    <>
  ...
  // "cursorarrow" — ToolbarView.swift pointer tool. Classic mouse-pointer arrow.
  cursor: (
    <>
  ...
  // "scissors" — ToolbarView.swift razor tool.
  scissors: (
    <>
  ...
  // "square.split.2x1" — ToolbarView.swift split-at-playhead button. Rect with a center divider.
  "split-clip": (
    <>
  ...
  // "minus.magnifyingglass" — ToolbarView.swift zoom-out. Shares the "search" glyph's magnifier.
  "zoom-out": (
    <>
      <circle cx="10" cy="10" r="6" />
      <line x1="14.5" y1="14.5" x2="20" y2="20" />
  ...
  // "plus.magnifyingglass" — ToolbarView.swift zoom-in.
  "zoom-in": (
    <>
      <circle cx="10" cy="10" r="6" />
      <line x1="14.5" y1="14.5" x2="20" y2="20" />
